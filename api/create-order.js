module.exports = async (req, res) => {
  ...
  const orderData = JSON.stringify({
    ...
    order_meta: {
      return_url: `https://studybuddypro-psi.vercel.app/api/verify-payment?order_id={order_id}&prn=${body.prn}&branch=${body.branch}&branchName=${encodeURIComponent(body.branchName || body.branch || '')}`,
    },
  });
